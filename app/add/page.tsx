  ...
  return (
    <main className="min-h-screen bg-[#F0EDE4] px-4 pb-28 pt-6">
      <div className="max-w-md mx-auto">
        {/* Header */}
        <h1 className="text-2xl font-extrabold text-[#2a2a2a] text-center mb-6">
          Add a place
        </h1>
        ...
        <button
          ...
          className="w-full h-36 border-2 border-dashed border-[#c8c0b0] rounded-2xl bg-white mb-5 flex flex-col items-center justify-center gap-1.5 overflow-hidden relative"
        >
          {photoPreview ? (
            <Image
              src={photoPreview}
            ...
            <>
              <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
                <rect
                  ...
                  strokeWidth="1.8"
                />
                <circle cx="9" cy="13" r="2.5" stroke="#c8c0b0" strokeWidth="1.8" />
                <path
