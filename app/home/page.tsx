...
{/* Headline + account icon */}
        <div className="flex justify-between items-start">
          ...
          <Link
            href="/profile"
            className="w-11 h-11 rounded-full bg-gradient-to-br from-[#F5C4B3] to-[#e8d4c0] border-2 border-white shadow-md flex items-center justify-center flex-shrink-0"
          >
        ...
        <Link
          href="/places"
          className="mt-5 bg-white border border-[#e8e4db] rounded-2xl px-4 py-3.5 flex items-center gap-3 block"
        >
        ...
        <div className="flex gap-2 mt-4 flex-wrap">
          ...
          <Link
            ...
            className="bg-white border border-[#e8e4db] text-[#2a2a2a] text-xs font-bold px-4 py-2 rounded-full"
          >
            Cafés
          </Link>
          <Link
        ...
        {/* Map preview */}
        <div className="mt-5 rounded-3xl overflow-hidden border border-[#e8e4db] h-72 relative">
        ...
        <div className="mt-5 flex flex-col gap-3">
          ...
          <Link
            href="/places"
            className="w-full py-3.5 rounded-full border-2 border-[#2a2a2a] text-[#2a2a2a] font-bold text-center"
          >
            Switch to list
          </Link>
        </div>
